...
def lambda_handler(event, context):
    ...
    convert_json_to_parquet(df_json_select, bucket, path_general, test_event_id) # TODO: uncomment if file conversion is in this lambda
    ...
    if (endpoint_exists_bool == False):
        ...
        try:
            endpoint_parameter_value = os.environ['endpoint_name'] # TODO: remove after testing
...
def send_data_to_rds(data, user_id, test_event_id):
    ...
    score = data["predictions"][0][0] * 100 # to change from a decimal to a percentage
